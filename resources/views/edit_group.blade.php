				...
				<div class="col-md-12">
					<div class="widget">
						...
						<div class="widget-content" style="margin: 0px;width:100%;">
                            ...
                            <!-- Login form -->
                            <form class="form-horizontal" action="/save-group/{{ $data['id'] }}" method='post'>
                                @csrf <!-- {{ csrf_field() }} -->
                            <!-- Email -->
                            <div class="form-group">
                                <label class="control-label col-lg-3" for="inputName">Group Name</label>
                                <div class="col-lg-4">
                                <input type="text" name="name" class="form-control" id="inputName" placeholder="Group Name" value="{{ $data['name'] }}" required>
                                </div>
                            </div>
                            <!-- Password -->
                            <!-- <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                <input type="text" name="code" class="form-control" id="inputCode" placeholder="Code" value="{{ $data['code'] }}" required>
                                </div>
                            </div> -->
