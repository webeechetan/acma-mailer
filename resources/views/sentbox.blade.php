								...
								<table id="datatable" class="table table-inbox  table-hover">
                                    ...
                                    @foreach($data as $lead)
                                        <tr class="mail-detail" id="{{ $lead['id'] }}" style="cursor:poniter;">
                                            ...
                                            <td>{{ $lead['subject'] }}</td>
                                            <th><button data-body="{{ $lead['body'] }}"   type="button" class="btn btn-primary" id="view_body" onclick="display_message(this)" data-toggle="modal" data-target="#exampleModalLong">
                                              View Body
                                            </button>
                                            </th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Mial Body</h5>
      </div>
